...
def train_source_depth(model, trainloader, targetloader, cfg):
    ...
    for i_iter in tqdm(range(cfg.TRAIN.EARLY_STOP + 1)):
        ...
        d_out_main = d_main(pred_trg_main)
        loss_adv_trg_main = bce_loss(d_out_main, source_label)
        loss = cfg.TRAIN.LAMBDA_ADV_MAIN * loss_adv_trg_main
        # d_out_main = d_main(prob_2_entropy(F.softmax(seg_depth_trg)))
        # loss_adv_trg_main = bce_loss(d_out_main, source_label)
        # loss += cfg.TRAIN.LAMBDA_ADV_MAIN * loss_adv_trg_main
        ...
        d_out_main = d_main(pred_src_main)
