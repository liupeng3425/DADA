...
def train_dada_gt_target_depth(model, trainloader, targetloader, cfg):
    ...
    for i_iter in tqdm(range(cfg.TRAIN.EARLY_STOP + 1)):
        ...
        _, pred_src_main, pred_depth_src_main, _ = model(images_source.cuda(device))
        ...
        _, pred_trg_main, pred_depth_trg_main, _ = model(images.cuda(device))
